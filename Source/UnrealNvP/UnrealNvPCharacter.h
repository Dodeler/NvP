...
#include "UnrealNvPCharacter.generated.h"

UCLASS(config=Game)
class AUnrealNvPCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AThrowingStar> ProjectileClass;
	...
	UPROPERTY(EditDefaultsOnly)
	UAnimMontage* ThrowAnimationMontage;
};
